...
📷 **[Для художника]** `ILL-T3-L7-01` · Вертикальная «лестница» запроса: ноутбук → Pi-hole (радужный круг) → облако «1.1.1.1» → здание «авторитетный DNS»; сбоку — **кэш** как полка с коробками «google.com — 120 с». Подпись: *«Каждый уровень что-то знает»*.

...
📷 **[Для художника]** `ILL-T3-L5-01` · Подросток 14 лет сидит в школьной библиотеке с ноутбуком; от экрана к дому тянется **светящийся зелёный туннель** сквозь «облако интернета»; в доме — Raspberry Pi с подписью «WireGuard»; на стене дома — иконки NAS и Pi-hole. Настроение: **спокойная** уверенность, не «хакерский» неон. Подпись: *«Туннель видишь только ты»*.

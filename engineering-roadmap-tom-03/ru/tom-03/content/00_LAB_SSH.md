...
📷 **ILL-T3-L0-01 · Ключ и туннель**  
**[Для художника]** Подросток 13–15 лет за ноутбуком; на экране терминал с `ssh pi`; от ноутбука к Raspberry Pi на столе — **светящийся туннель** (не провода); у Pi на «двери» — **замок**, у подростка в руке — **ключ**; настроение: «я инженер, не хакер»; подпись: «SSH — дверь без монитора».

...
📷 **[Для художника]** `ILL-T3-L6-01` · Комната подростка: на мониторе — панель Home Assistant с плитками «Свет», «Температура», «VPN»; Raspberry Pi на полке с мягкой подсветкой; тонкие линии от Pi к лампе и к датчику на стене. Стиль **тёплый**, не sci-fi. Подпись: *«Один мозг — много устройств»*.

...
📷 **[Для художника]** `ILL-T3-L8-01` · Вид сверху на квартиру как **схему**: роутер в центре, линии к ноутбуку, телефону, Raspberry Pi (подпись NAS/HA), принтеру, телевизору; за окном — «интернет»; легенда цветов: зелёный = серверы, серый = клиенты. Подпись: *«Диспетчерская квартиры»*.

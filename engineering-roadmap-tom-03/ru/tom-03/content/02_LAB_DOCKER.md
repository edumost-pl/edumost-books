...
📷 **ILL-T3-L2-01 · Контейнеры на Pi**  
**[Для художника]** Raspberry Pi сверху — как **пристань**; на ней 3 **прозрачные коробки** (nginx, pi-hole, meteo); каждая со своей этикеткой порта; ноутбук по Wi‑Fi стучится на `:8080`; подпись: «Одна Pi — много служб, без хаоса».

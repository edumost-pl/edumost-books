...
📷 **[Для художника]** Старый ноутбук в углу комнаты, тихо светится LED; кабель Ethernet к роутеру; на экране — терминал с `uptime`; подпись «работает, пока ты спишь».

📷 **[Для художника]** Два экрана: слева — игровой ПК с иконками; справа — чёрный терминал с зелёным `uptime 30 days`.

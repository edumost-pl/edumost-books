...
📷 **[Для художника]** `ILL-T5-L7-01` · **CubeSat** **на** **столе** (или **3D model**); **экран** — **Mission Control** **dark** UI: **battery**, **temp**, **link**; **задержка** **«RTT 12 min»**; **Земля** **в** **окне** **stylized**; badge 🟣. Подпись: *«Далеко — значит автономно»*.

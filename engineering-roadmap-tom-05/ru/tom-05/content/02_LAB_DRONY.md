...
📷 **[Для художника]** `ILL-T5-L2-01` · Вид **сверху-сбоку** на квадрокоптер: **4 мотора** с стрелками вращения (CW/CCW), **центр** — FC (flight controller), **стрелки осей** X/Y/Z; подпись **Roll/Pitch/Yaw**; фон — **симулятор** на мониторе; badge 🟣. Подпись: *«Четыре мотора — один баланс»*.

...
📷 **[Для художника]** `ILL-T5-L0-01` · Подросток 17–18 лет за столом: слева — **стопка карточек** «кошка / не кошка» (данные), в центре — **прозрачный блок «Модель»** с простыми узлами, справа — **экран** с процентом уверенности; **фиолетовый** badge «🟣 Архитектор»; на полке — мини-робот из Тома 4 **смотрит** на экран. Настроение: **лаборатория будущего**, не sci-fi хоррор. Подпись: *«Данные → Модель → Решение»*.

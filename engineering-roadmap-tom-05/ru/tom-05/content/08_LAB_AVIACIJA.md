...
📷 **[Для художника]** `ILL-T5-L8-01` · **Cutaway** **учебного** **Cessna-style** **с** **4** **стрелками** **сил** **L/D/T/W**; **insert** **малый** **дрон** **с** **подписью** «другой** **режим** **полёта**»; **checklist** **clipboard**; badge 🟣. Подпись: *«Подъём ≠ магия»*.

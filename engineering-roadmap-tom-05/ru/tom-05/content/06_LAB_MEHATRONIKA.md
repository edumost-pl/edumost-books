...
📷 **[Для художника]** `ILL-T5-L6-01` · **Servo arm** на **3D-printed** base; **стрелки** loop: Sensor → MCU → Driver → Motor → Mechanism → Sensor; **осциллограф** stylized **PWM**; badge 🟣. Подпись: *«Замкнутый контур»*.

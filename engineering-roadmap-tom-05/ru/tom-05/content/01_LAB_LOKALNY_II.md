...
📷 **[Для художника]** `ILL-T5-L1-01` · Ноутбук: слева **облако** с пунктирной стрелкой «промпт уехал» (перечёркнуто), справа **коробка «Ollama localhost»** с **зелёной** галочкой; на втором мониторе — **htop** с **RAM 78%**; badge 🟣. Подпись: *«Мозг — дома»*.

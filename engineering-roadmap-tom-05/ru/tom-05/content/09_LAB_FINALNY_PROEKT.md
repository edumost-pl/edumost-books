...
📷 **[Для художника]** `ILL-T5-L9-01` · **Торжественный** **плакат** **«50→1»**: **центр** — **твоя** **система** **(robot/drone/station)** **на** ** столе**; **по** **кругу** **10** **иконок** **лабораторий** **Тома** **5**; **фон** — **silhouettes** **4** **прошлых** **томов** **(Pi, LED, Docker, robot)**; **badge** **🟣** **крупно**; **подпись**: *«Архитектор технологий · Финал академии»*.

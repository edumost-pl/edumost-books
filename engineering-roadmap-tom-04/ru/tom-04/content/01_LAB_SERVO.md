...
📷 **[Для художника]** **ILL-T4-L1-01 · Серво под углом**

| | |
|--|--|
| **Главный объект** | SG90 на breadboard, **оранжевый** рычаг под **45°**, транспортир нарисован на фоне |
| **Ракурс** | Сбоку — видны **3 провода**: коричневый GND, красный 5V, оранжевый сигнал → D9 |
| **Выделить** | Дуга **0°–180°** и подпись текущего угла на экране Serial |
| **Настроение** | Точность, **инженерная** аккуратность |
| **Подпись** | «90° — не магия, а **обратная связь**» |

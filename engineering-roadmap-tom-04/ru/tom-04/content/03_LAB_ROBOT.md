...
📷 **[Для художника]** **ILL-T4-L3-01 · Первый робот на полу**

| | |
|--|--|
| **Главный объект** | Низкое 2WD шасси, **HC-SR04** «глазами» вперёд, Arduino + L298N сверху |
| **Ракурс** | Низко с пола — робот **едет** к картонной коробке, **15 см** до стены |
| **Выделить** | Красная зона «< 15 cm» и **стоп** моторов (иконка ⏹) |
| **Настроение** | Драйв + **безопасность** |
| **Подпись** | «Собрал · Прошил · Остановил **до** удара» |

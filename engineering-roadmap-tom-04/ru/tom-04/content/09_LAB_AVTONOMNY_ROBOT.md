...
📷 **[Для художника]** **ILL-T4-L9-01 · Диплом Создателя роботов**

| | |
|--|--|
| **Главный объект** | Робот на **чёрной** трассе, **Pi** и **Arduino** видны, **камера** вперёд |
| **Ракурс** | Низкий — как **POV** зрителя у пола, на заднем плане **плакат** 🔴 |
| **Выделить** | **Зелёная** галочка «Цикл 2/2» на планшете с логом |
| **Настроение** | **Гордость** без хаоса — стол **аккуратный** |
| **Подпись** | «Первый автономный · **v1.0**» |

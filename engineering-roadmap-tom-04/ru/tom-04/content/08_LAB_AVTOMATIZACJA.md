...
📷 **[Для художника]** **ILL-T4-L8-01 · Машина состояний**

| | |
|--|--|
| **Главный объект** | Плакат с **5** кругами-состояниями и стрелками переходов |
| **Ракурс** | Над роботом на полу — как **карта метро** |
| **Выделить** | Красная стрелка **AVOID** от ультразвука — **толще** остальных |
| **Настроение** | Порядок, **контроль** |
| **Подпись** | «Не if-спагетти — **режимы**» |

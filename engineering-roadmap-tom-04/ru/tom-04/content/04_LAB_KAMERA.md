...
📷 **[Для художника]** **ILL-T4-L4-01 · Глаз на Pi**

| | |
|--|--|
| **Главный объект** | Pi 4 с **CSI-лентой** к модулю камеры на **маленьком штативе** |
| **Ракурс** | Сбоку: на экране терминала `libcamera-still -o test.jpg` и превью кадра |
| **Выделить** | Лента CSI **синяя** сторона к Ethernet (классическое правило) |
| **Настроение** | «Мир стал **данными**» |
| **Подпись** | «Кадр сохранён — зрение **началось**» |

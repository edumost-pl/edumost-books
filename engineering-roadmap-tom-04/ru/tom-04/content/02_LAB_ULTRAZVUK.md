...
📷 **[Для художника]** **ILL-T4-L2-01 · Сонар на столе**

| | |
|--|--|
| **Главный объект** | HC-SR04 на breadboard, **волны** (стилизованные дуги) к картонной «стене» |
| **Ракурс** | Спереди — видны Trig/Echo, Serial Monitor `Dist: 34 cm` |
| **Выделить** | Ладонь на расстоянии **20 см** — LED **красный** |
| **Настроение** | Робот **осторожен**, не робот-таран |
| **Подпись** | «Эхо → сантиметры → решение» |

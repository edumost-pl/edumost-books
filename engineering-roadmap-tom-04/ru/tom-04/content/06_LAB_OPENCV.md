...
📷 **[Для художника]** **ILL-T4-L6-01 · OpenCV на Pi**

| | |
|--|--|
| **Главный объект** | Экран с **тремя** панелями: исходник / маска / контур с зелёной линией |
| **Ракурс** | Pi + камера на роботе, в углу **FPS: 12.4** |
| **Выделить** | ROI — нижняя **половина** кадра (прямоугольник) |
| **Настроение** | Скорость + **контроль** |
| **Подпись** | «Библиотека = время на **логику**, не на математику» |

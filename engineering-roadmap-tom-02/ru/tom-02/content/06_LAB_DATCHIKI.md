...
📷 **[Для художника]** **ILL-T2-L6-01 · Первое чтение датчика**

| | |
|--|--|
| **Главный объект** | Breadboard с **DHT22** (белая «решётка») и цветными проводами к Pi |
| **Ракурс** | 3/4 сверху — видны **экран Pi** с цифрами `23.4°C 51%`, **руки** ребёнка 12–13 лет |
| **Выделить** | DATA-провод — **жёлтая** стрелка; pull-up резистор — **кружок** с подписью «10k» |
| **Настроение** | «Ого, комната **измеряется**!» — не школа, **лаборатория дома** |
| **Подпись** | На экране: `T=23.4 H=51` |

...
📷 **[Для художника]** **ILL-T2-L9-01 · Домашняя метеостанция**

| | |
|--|--|
| **Главный объект** | Pi на полке, **breadboard** с DHT22, **LED**, **кнопка**; **монитор** с **графиком** T/H |
| **Ракурс** | Широкий кадр комнаты — **окно** слева *(опционально ESP32 на подоконнике)* |
| **Выделить** | Стрелка **данные** → CSV → **график**; LED **зелёный** «REC» |
| **Настроение** | **Гордость** — «**я** это **собрал**» |
| **Подпись** | «Tom 2 · Projekt **Meteo**» |

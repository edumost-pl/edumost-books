...
📷 **[Для художника]** **ILL-T2-L8-01 · ESP32 и Wi‑Fi**

| | |
|--|--|
| **Главный объект** | ESP32 DevKit **напечатанная** плата, **синий** LED мигает |
| **Ракурс** | Сверху 3/4 — **USB** слева, **экран ноутбука** справа с `WiFi: 5 sieci` |
| **Выделить** | **Волны Wi‑Fi** от чипа (стилизованно); Pi **серым** на заднем плане («большой брат») |
| **Настроение** | «**Маленький**, но **в сети**!» |
| **Подпись** | «ESP32 · Wi‑Fi **w środku**» |
